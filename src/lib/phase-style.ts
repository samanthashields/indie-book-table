...
const styles: Record<string, PhaseStyle> = {
  writing_development: { marker: "bg-inkblue text-primary-foreground border-inkblue", chip: "border-inkblue/30 bg-inkblue/12 text-foreground", dot: "text-inkblue", soft: "bg-inkblue/8" },
