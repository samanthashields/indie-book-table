...
function AdminOnboarding() {
  ...
  return <div className="space-y-8">
    ...
    <section>
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3"><div><h2 className="font-heading text-2xl font-normal">Walkthrough screens</h2><p className="mt-1 text-sm text-muted-foreground">Order and publish the screens authors see.</p></div><div className="flex gap-2"><Button variant="outline" onClick={() => window.dispatchEvent(new CustomEvent(OPEN_WORKSHOP_TOUR, { detail: { preview: true } }))}><Eye />Preview published</Button><Button onClick={() => setAdding(true)}><Plus />Add screen</Button></div></div>
