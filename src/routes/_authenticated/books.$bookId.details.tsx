...
const fields = ["title", "subtitle", "pen_name", "genre", "series", "edition", "audience", "comparables", "goals", "length_estimate", "language", "trim_size", "isbn", "imprint", "price", "publishing_path", "target_publication_date", "budget"] as const;
