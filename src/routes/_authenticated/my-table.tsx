      ...
      {isLoading ? (
        ...
        <div className="space-y-10">
          <section className="grid gap-3 rounded-2xl border border-border bg-card p-2 shadow-xs sm:grid-cols-3" aria-label="Your totals">
            <div className="rounded-xl border border-border bg-card px-4 py-4"><p className="text-sm font-semibold">Books published</p><p className="mt-1 text-2xl font-semibold">{publishedCount}</p></div>
            <div className="rounded-xl border border-border bg-card px-4 py-4"><p className="text-sm font-semibold">Cycles completed</p><p className="mt-1 text-2xl font-semibold">{cyclesCompleted}</p></div>
            <div className="rounded-xl border border-border bg-card px-4 py-4"><p className="text-sm font-semibold">Published this year</p><p className="mt-1 text-2xl font-semibold">{publishedThisYear}</p></div>
          </section>
