...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-11 w-full cursor-pointer items-center justify-between whitespace-nowrap rounded-xl border border-input bg-card px-4 py-2 text-sm shadow-xs ring-offset-background transition-all data-[placeholder]:text-muted-foreground focus:border-primary/50 focus:outline-none focus:ring-3 focus:ring-ring/15 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
      className,
    )}
    {...props}
  >
