...
interface SheetContentProps
  ...
  /** Set false to open the panel without dimming the page behind it. */
  dim?: boolean;
}
...
const SheetContent = React.forwardRef<
  ...
  SheetContentProps
>(({ side = "right", className, children, dim = true, ...props }, ref) => (
  <SheetPortal>
    <SheetOverlay className={dim ? undefined : "bg-transparent"} />
